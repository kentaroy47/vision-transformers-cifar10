...
class minViT(nn.Module):
    def __init__(self, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, channels=3):
        ...
        self.transformer = nn.TransformerEncoder(
            nn.TransformerEncoderLayer(d_model=dim, nhead=heads, dim_feedforward=mlp_dim, activation='gelu'),
            num_layers=depth
        )
...
class Rearrange(nn.Module):
    ...
    def forward(self, x):
        return x.view(x.shape[0], -1, self.axes_lengths['p1'] * self.axes_lengths['p2'] * x.shape[1])
